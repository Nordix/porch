...
func pkgRevResourceReadFromDB(prk repository.PackageRevisionKey, resKey string) (string, string, error) {
	...
	err := GetDB().db.QueryRow(
		sqlStatement, prk.GetPackageKey().GetRepositoryKey().Namespace, prk.GetPackageKey().GetRepositoryKey().Name, prk.GetPackageKey().Package, prk.Revision, prk.WorkspaceName).Scan(
		&resVal)
...
func pkgRevResourcesReadFromDB(prk repository.PackageRevisionKey) (map[string]string, error) {
	...
	rows, err := GetDB().db.Query(sqlStatement, prk.GetPackageKey().GetRepositoryKey().Namespace, prk.GetPackageKey().GetRepositoryKey().Name, prk.GetPackageKey().Package, prk.Revision, prk.WorkspaceName)
	if err != nil {
...
func pkgRevResourceWriteToDB(pr *dbPackageRevision, resKey string, resVal string) error {
	...
	if _, err := GetDB().db.Exec(
		sqlStatement,
		prk.GetPackageKey().GetRepositoryKey().Namespace, prk.GetPackageKey().GetRepositoryKey().Name, prk.GetPackageKey().Package, prk.Revision, prk.WorkspaceName,
...
func pkgRevResourcesDeleteFromDB(prk repository.PackageRevisionKey) error {
	...
	_, err := GetDB().db.Exec(sqlStatement, prk.GetPackageKey().GetRepositoryKey().Namespace, prk.GetPackageKey().GetRepositoryKey().Name, prk.GetPackageKey().Package, prk.Revision, prk.WorkspaceName)
...
func pkgRevResourceDeleteFromDB(prk repository.PackageRevisionKey, resKey string) error {
	...
	_, err := GetDB().db.Exec(sqlStatement, prk.GetPackageKey().GetRepositoryKey().Namespace, prk.GetPackageKey().GetRepositoryKey().Name, prk.GetPackageKey().Package, prk.Revision, prk.WorkspaceName, resKey)
