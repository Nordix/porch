...
func (m *upgradePackageMutation) apply(ctx context.Context, _ repository.PackageResources) (repository.PackageResources, *porchapi.TaskResult, error) {
	...
	if err = repository.UpstreamPlaceholderCheck(ctx, m.namespace, m.referenceResolver, targetUpstreamRevision); err != nil {
	...
	if err = repository.UpstreamPlaceholderCheck(ctx, m.namespace, m.referenceResolver, localRevision); err != nil {
		return repository.PackageResources{}, nil, err
	}
