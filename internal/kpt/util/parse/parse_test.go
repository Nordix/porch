...
func Test_parseURL(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"no ref": {
			ghURL:    "https://github.com/kptdev/kpt-functions-catalog.git/examples/apply-replacements-simple",
			expected: expected{repo: "https://github.com/kptdev/kpt-functions-catalog", dir: "/examples/apply-replacements-simple", version: ""},
		},
