...
CREATE TABLE IF NOT EXISTS package_revisions (
    ...
    tasks                  TEXT NOT NULL,
    kptfile_conditions     TEXT NOT NULL DEFAULT '[]',
    kptfile_readiness_gates TEXT NOT NULL DEFAULT '[]',
    kptfile_labels         TEXT NOT NULL DEFAULT '{}',
    kptfile_annotations    TEXT NOT NULL DEFAULT '{}',
    PRIMARY KEY (k8s_name_space, k8s_name),
