...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubpackageSpec) DeepCopyInto(out *SubpackageSpec) {
	*out = *in
	out.Parent = in.Parent
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubpackageSpec.
func (in *SubpackageSpec) DeepCopy() *SubpackageSpec {
	if in == nil {
		return nil
	}
	out := new(SubpackageSpec)
	in.DeepCopyInto(out)
	return out
}
