...
func Wipe(t *suiteutils.MultiClusterTestSuite) {
	...
	// 	t.Fatalf("error wiping Porch cluster with CR cache: error deleting Kind cluster %q: %w", crCacheCluster, err)
	// }
...
func UseCRCacheCluster(t *suiteutils.MultiClusterTestSuite) {
	...
	t.Logf("Switching kubeconfig to Porch cluster with CR cache")
