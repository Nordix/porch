...
func (_c *MockPackageRevision_GetLock_Call) Return(upstream v1.Upstream, v v1.UpstreamLock, err error) *MockPackageRevision_GetLock_Call {
...
func (_c *MockPackageRevision_GetUpstreamLock_Call) Return(upstream v1.Upstream, v v1.UpstreamLock, err error) *MockPackageRevision_GetUpstreamLock_Call {
	_c.Call.Return(upstream, v, err)
	return _c
}
